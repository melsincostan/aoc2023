...
pub fn solve(input: &str) -> u32 {
    ...
    loop {
        ...
        match point_type {
            ...
            '|' | '-' => {
                let next_points = next_point_splitter(&point_to_visit, point_type, grid_height, grid_width);
...
fn next_point_splitter(
    ...
    if splitter == '|' {
        match current_point.direction {
            Direction::Down | Direction::Up => points.push(next_point_dot(&point_a, grid_height, grid_width)),
        ...
        match current_point.direction {
            Direction::Left | Direction::Right => points.push(next_point_dot(&point_a, grid_height, grid_width)),
